...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#196193] py-10 text-white w-full">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center pb-10 md:py-5">
