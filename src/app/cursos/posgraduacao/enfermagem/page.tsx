    ...
    <main className="flex flex-col min-h-screen">
      <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] h-[778px]">
        <div className="absolute inset-0">
          <Image
            src={isMobile ? "/enfermagem-hero-mobile.png" : "/enfermagem-hero.png"}
            alt="Imagem de fundo"
            layout="fill"
            objectFit="cover"
            priority
        ...
        >
          ...
          <p
            className={`text-white text-left font-semibold text-lg uppercase tracking-wide ${isMobile ? "text-xs" : ""}`}
          >
            enfermagem
          </p>
          <h1
          ...
          <ScrollLink to="section-form" smooth={true} duration={500}>
            <div className={`mt-${isMobile ? "" : 8}`}>
              <Button
                variant="default"
                size="default"
                className="text-white font-semibold hover:scale-110 transition-transform duration-300 ease-in-out"
              >
      ...
      <section>
        {isMobile ?
          <div className="flex flex-col items-center gap-4 py-10">
            ...
            <p className="font-medium text-lg text-pretty leading-relaxed">
              Queremos que você, <i>Enfermeiro</i>, faça parte da nossa família e se una a nós
          ...
          : <div className="flex flex-col gap-8 py-10 mb-10">
            <div className="flex flex-row gap-10 pt-8">
              <div className="flex flex-col justify-center gap-6">
                ...
                <p className="font-medium text-lg text-pretty leading-relaxed">
                  Queremos que você, <i>Enfermeiro</i>, faça parte da nossa família e se una a
